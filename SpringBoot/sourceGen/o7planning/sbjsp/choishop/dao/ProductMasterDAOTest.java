...
public class ProductMasterDAOTest {
	 ...
	 *
	 */
	private ProductMasterDAO dataStore;

	/**
	 * Instantiates a new ProductMasterDAOTest.
	 *
	 */
	public ProductMasterDAOTest() {
	}

	/**
	* Method to test ProductMaster domain object.
	*
	*/
	@Rollback(false)
	@Test
	...
	*/
	@Autowired
	public void setDataStore(ProductMasterDAO dataStore) {
