...
<html>
<head>
<title>View <fmt:message key="customermaster.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="customermaster.title"/> Details</h1>
			...
			<table cellpadding="0" cellspacing="0" id="viewTable">
				<tbody>
					...
					<tr>
						...
						<td>
							${customermaster.describeCustommer}
						&nbsp;
						</td>
					</tr>
					<tr>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteCustomerMaster?codeKey=${customermaster.code}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
